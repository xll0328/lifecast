...
> 实验足迹：49 个 Phase 2 原始实验 JSON（其中 41 个完成结果 + 8 个 `skipped_small_group` 占位）+ 2 个 tracker JSON + `results/phase2_summary/` 统一 summary 层 + 10 张最终主图
...
![Phase 2 Figure 9: pooled uncertainty](results/phase2_figures/phase2_fig9_us_pooled_delta_uncertainty.png)
...
![Phase 2 Figure 10: pooled support map](results/phase2_figures/phase2_fig10_us_pooled_support_vs_delta.png)
